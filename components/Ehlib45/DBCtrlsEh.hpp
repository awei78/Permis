...
public:
	...
	virtual bool __fastcall IsDataIndepended(void);
...
protected:
	...
	virtual void __fastcall CalcEditRect(Types::TRect &ARect);
	...
	virtual void __fastcall EditButtonDown(System::TObject* Sender, bool TopButton, bool &AutoRepeat, bool &Handled);
	virtual void __fastcall EditButtonMouseMove(System::TObject* Sender, Classes::TShiftState Shift, int X, int Y);
	virtual void __fastcall EditButtonMouseUp(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	virtual void __fastcall EditingChanged(void);
	...
	void __fastcall MRUListControlMouseUp(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState Shift, int X, int Y);
	...
	virtual void __fastcall PaintRequiredState(Graphics::TCanvas* ACanvas);
	...
	virtual void __fastcall UpdateHintProcessing(void);
	...
	__property bool HighlightRequired = {read=FHighlightRequired, write=FHighlightRequired, default=0};
	...
	__property TOnCheckDrawRequiredStateEventEh OnCheckDrawRequiredState = {read=FOnCheckDrawRequiredState, write=FOnCheckDrawRequiredState};
...
public:
	...
	__property bool Tooltips = {read=FTooltips, write=SetTooltips, default=0};
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomDBEditEh(HWND ParentWindow) : Mask::TCustomMaskEdit(ParentWindow) { }
	#pragma option pop
...
public:
	operator IInterface*(void) { return (IInterface*)&__IComboEditEh; }
...
public:
	#pragma option push -w-inl
	/* TCustomDBEditEh.Create */ inline __fastcall virtual TDBEditEh(Classes::TComponent* AOwner) : TCustomDBEditEh(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomDBDateTimeEditEh(HWND ParentWindow) : TCustomDBEditEh(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomDBNumberEditEh(HWND ParentWindow) : TCustomDBEditEh(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TCustomDBNumberEditEh.Create */ inline __fastcall virtual TDBNumberEditEh(Classes::TComponent* AOwner) : TCustomDBNumberEditEh(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDBNumberEditEh(HWND ParentWindow) : TCustomDBNumberEditEh(ParentWindow) { }
	#pragma option pop
...
protected:
	...
	DYNAMIC void __fastcall Click(void);
	virtual void __fastcall CreateWnd(void);
	virtual void __fastcall DrawCaptionRect(const Types::TRect &ARect, bool AFocused, bool AMouseAboveControl, bool ADown);
	virtual void __fastcall DrawCheckBoxRect(const Types::TRect &ARect, Stdctrls::TCheckBoxState AState, bool AFocused, bool AMouseAboveControl, bool ADown);
	virtual void __fastcall DrawState(Stdctrls::TCheckBoxState AState, bool AFocused, bool AMouseAboveControl, bool ADown);
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomDBCheckBoxEh(HWND ParentWindow) : Stdctrls::TButtonControl(ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TCustomDBCheckBoxEh.Create */ inline __fastcall virtual TDBCheckBoxEh(Classes::TComponent* AOwner) : TCustomDBCheckBoxEh(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDBCheckBoxEh(HWND ParentWindow) : TCustomDBCheckBoxEh(ParentWindow) { }
	#pragma option pop
