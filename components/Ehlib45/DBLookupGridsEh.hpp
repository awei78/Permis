...
protected:
	...
	virtual void __fastcall DrawSubTitleCell(int ACol, int ARow, int DataCol, int DataRow, Dbgrideh::TCellAreaTypeEh CellType, const Types::TRect &ARect, Gridseh::TGridDrawState AState, bool &Highlighted);
