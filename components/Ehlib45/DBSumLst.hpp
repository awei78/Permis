...
// (DO NOT EDIT: machine generated header) 'Dbsumlst.pas' rev: 11.00
...
public:
	TDBSum* operator[](int Index) { return Items[Index]; }
...
public:
	#pragma option push -w-inl
	/* TCollection.Create */ inline __fastcall TDBSumCollection(TMetaClass* ItemClass) : Classes::TCollection(ItemClass) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	...
	bool FTryedInsert;
	Toolctrlseh::TBMListEh* FVirtualRecList;
