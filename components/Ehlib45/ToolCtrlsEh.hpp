...
typedef Set<Db::TFieldType, Db::ftUnknown, Db::ftOraInterval>  TFieldTypes;
...
extern PACKAGE void __fastcall FillGradientEh(Graphics::TCanvas* Canvas, const Types::TRect &Rect, Graphics::TColor FromColor, Graphics::TColor ToColor)/* overload */;
