...
procedure FillGradientEh(Canvas: TCanvas; Rect: Trect; FromColor, ToColor: TColor); overload;
...
procedure FillGradientEh(Canvas: TCanvas; Rect: TRect; FromColor, ToColor: TColor);
var
  h,i: Integer;
  rgb1, rgb2: Integer;
