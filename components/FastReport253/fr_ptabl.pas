...
{$ENDIF}
    ...
    function TryToFitWidth(var Widths: TfrWidthsArray; DataColumns, ADesiredWidth, AThresold: integer; AFields: WideString; AOptions: TfrShrinkOptions): boolean;
...
function TfrCustomPrintDataSet.TryToFitWidth(var Widths: TfrWidthsArray; DataColumns, ADesiredWidth, AThresold: integer; AFields: WideString; AOptions: TfrShrinkOptions): boolean;
var
