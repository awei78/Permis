...
begin
  ...
  if (AnsiCompareFileName(fname,Comp) = 0) then
    // Allow conversion
    fname := Dest
  else
...
{
{   Rev 1.0.1.2    11/26/2007 8:42:54 PM  Delphi7    Version: Before Encryption
{ Fix problem when empty zip
}
{
{   Rev 1.0.1.1    11/6/2007 12:51:40 PM  Delphi4    Version: Before Encryption
{ AnsiSameStr is not compatible with D4
}
{
{   Rev 1.0.1.0    11/4/2007 3:13:20 PM  BCB 2006    Version: Before Encryption
{ Simplify isRunning
}
{
